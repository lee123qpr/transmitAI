        ...
        <div className="flex flex-col">
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
                    ...
                    <div className="text-left">
                        <h1 className="text-[2.5rem] leading-[1] sm:text-6xl lg:text-7xl font-bold tracking-tight text-slate-900 mb-8 flex flex-col items-start space-y-0 sm:-space-y-1 lg:-space-y-3">
                            <span className="pb-1">Turn 100 Drawings</span>
                            <span className="pb-1">into a</span>
                        ...
                        <p className="text-xl text-slate-600 mb-8 max-w-lg leading-relaxed">
                            Stop manually typing out document registers. Transmit.AI auto-extracts drawing numbers, revisions, and titles from your PDFs instantly—so you can go home on time.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <SignUpButton mode="modal" forceRedirectUrl="/app">
                                <button className="px-8 py-4 text-lg font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl shadow-xl shadow-blue-500/20 transition-all hover:scale-105 hover:-translate-y-1 flex items-center justify-center gap-2">
                                    Claim Your 10 Free Documents Per Month <ArrowRight size={20} />
                                </button>
                            </SignUpButton>
                            <button
                        ...
                        <p className="mt-6 text-sm text-slate-900 font-bold bg-green-100/50 inline-block px-3 py-1 rounded-md border border-green-200">
                        ...
                        <p className="mt-4 text-xs font-semibold text-slate-500 flex items-center gap-1.5">
                            ...
                            Trusted by Document Controllers across the UK
                        </p>
                    </div>
            ...
            <section className="py-24 bg-white border-t border-slate-100">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-4xl font-bold text-slate-900 mb-6">Stop Spending Fridays Formatting Spreadsheets.</h2>
                    <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
                        Create your first automated transmittal in 60 seconds. Get your time back to focus on actual document control, not just data entry.
                    </p>
